...
EXPERIMENT_ROOT="/home/jincai_guo/tianqi/CVPR2027/checkpoints/lawam_cl/libero_goal/seq_single_task_nonlinear_v9/${MODE}/task${TASK_ID}"
RUN_ROOT="${EXPERIMENT_ROOT}/runs"; LOG_ROOT="${EXPERIMENT_ROOT}/logs"
OUTPUT_ROOT="${ROOT}/results/eval_runs/lawam_cl/libero_goal/seq_single_task_nonlinear_v9/${MODE}/task${TASK_ID}"
MERGE_SCRIPT="${ROOT}/scripts/merge_lora_checkpoint_v6.py"
VERIFY_SCRIPT="${ROOT}/scripts/verify_seq_single_nonlinear_v9.py"
