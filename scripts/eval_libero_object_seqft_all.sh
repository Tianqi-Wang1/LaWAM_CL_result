...
CKPT_ROOT="/home/jincai_guo/tianqi/CVPR2027/checkpoints/lawam_cl/libero_object/seqft"

OUTPUT_ROOT="results/eval_runs/lawam_cl/libero_object/seqft_full"
...
echo
echo "=========================================================="
echo " LaWAM LIBERO-object CL Evaluation"
echo "=========================================================="
...
run_eval_stage() {
    ...
    local suite_dir
    suite_dir="${eval_timestamp_dir}/suites/libero_object"
