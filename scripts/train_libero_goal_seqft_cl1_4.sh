...
echo
echo "=========================================================="
echo " LaWAM LIBERO-Goal Sequential Fine-Tuning"
echo "=========================================================="
echo
echo "Base tasks       : Goal 0-5"
echo "CL1              : Goal 6"
echo "CL2              : Goal 7"
echo "CL3              : Goal 8"
echo "CL4              : Goal 9"
...
echo
echo "=========================================================="
echo " LaWAM Goal CL1 -> CL4 completed successfully"
echo "=========================================================="
echo
echo "Base:"
echo "  ${BASE_RUN}"
