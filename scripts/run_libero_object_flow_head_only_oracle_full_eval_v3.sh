...
# subsequent LIBERO-Object task be learned by adapting ONLY a new Flow action head?
#
...
EXPERIMENT_ROOT="/home/jincai_guo/tianqi/CVPR2027/checkpoints/lawam_cl/libero_object/flow_head_only_oracle"
RUN_ROOT="${EXPERIMENT_ROOT}/heads"

OUTPUT_ROOT="${ROOT}/results/eval_runs/lawam_cl/libero_object/flow_head_only_oracle"
...
# =============================================================================
# 9. Locate the formal Object Base
# =============================================================================
...
echo
echo "=========================================================="
echo " LaWAM Object: Frozen-Upstream + Flow-Head-Only Oracle"
