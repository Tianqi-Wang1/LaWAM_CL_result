...
# =============================================================================
# T9 FT-SPREAD4: dense fine-tune original Base Flow layers 0,5,10,15
...
EXPERIMENT_ROOT="/home/jincai_guo/tianqi/CVPR2027/checkpoints/lawam_cl/libero_goal/t9_partial_dense_followup_v3/ft_spread4"
RUN_ROOT="${EXPERIMENT_ROOT}/runs"
LOG_ROOT="${EXPERIMENT_ROOT}/logs"
OUTPUT_ROOT="${ROOT}/results/eval_runs/lawam_cl/libero_goal/t9_partial_dense_followup_v3/ft_spread4"
...
DENSE_LAYER_INDICES="[0,5,10,15]"
DENSE_LAYER_CSV="0,5,10,15"
...
RUN_ID="t9_ft_spread4_0_5_10_15_${MAX_TRAIN_STEPS}step_4gpu_bs${PER_DEVICE_BATCH_SIZE}_ga${GRADIENT_ACCUMULATION_STEPS}"
MASTER_LOG="${LOG_ROOT}/${RUN_ID}_${STAMP}.log"
exec > >(tee -a "${MASTER_LOG}") 2>&1

echo "=========================================================="
echo " T9 FT-SPREAD4: dense fine-tune original Base Flow layers 0,5,10,15"
echo "=========================================================="
echo "Base          : ${BASE_CKPT}"
...
export MAIN_PROCESS_PORT="${MAIN_PROCESS_PORT:-29932}"
